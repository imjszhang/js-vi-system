...
function generateTokensCSS() {
  const lines = [
    ...
    '',
    '  /* Colors — Auxiliary */',
    `  --js-color-logo-fill: ${colors.auxiliary['logo-fill'].value};`,
    '',
    '  /* Colors — Semantic */',
    `  --js-color-error: ${colors.semantic.error.value};`,
    `  --js-color-info: ${colors.semantic.info.value};`,
    `  --js-color-success: ${colors.semantic.success.value};`,
    '',
    '  /* Colors — Surface */',
    `  --js-color-grid-line: ${colors.surface['grid-line'].value};`,
    `  --js-color-scrollbar-hover: ${colors.surface['scrollbar-hover'].value};`,
    `  --js-color-placeholder: ${colors.surface.placeholder.value};`,
    '',
    '  /* Typography */',
